...
![Google search result for Ubuntu 22.04 LTS Jammy Jellyfish download page](ubuntu-to-wazuh/01_ubuntu_google_search_result.png)
**Fig-1:** Google search result for Ubuntu 22.04 LTS Jammy Jellyfish download page.




![Ubuntu release directory showing the 22.04.5 desktop AMD64 ISO file](ubuntu-to-wazuh/02_ubuntu_release_directory_desktop_amd64_iso.png)
...
![VMware Workstation Pro home screen before creating the virtual machine](ubuntu-to-wazuh/04_vmware_workstation_home_before_creating_vm.png)
**Fig-3:** VMware Workstation Pro home screen before creating the virtual machine.


![New Virtual Machine Wizard, Typical configuration selected](ubuntu-to-wazuh/05_new_virtual_machine_wizard_typical_configuration.png)
...
![Guest operating system installation, choose to install the OS later](ubuntu-to-wazuh/06_guest_os_install_later.png)

**Fig-5:** Guest operating system installation, choose to install the OS later.


![Select Linux as the guest OS and Ubuntu as the version](ubuntu-to-wazuh/07_select_linux_ubuntu_guest_os.png)
...
![Name the VM Ubuntu (2) and choose the VM storage location](ubuntu-to-wazuh/08_name_vm_ubuntu_2_and_location.png)

**Fig-7:**  Name the VM Ubuntu (2) and choose the VM storage location.



![Specify disk capacity, 20 GB, split into multiple files](ubuntu-to-wazuh/09_specify_disk_capacity_20gb_split.png)

**Fig-8:** Specify disk capacity, 20 GB, split into multiple files.


![Ready to create the virtual machine summary page](ubuntu-to-wazuh/10_ready_to_create_vm_summary.png)

**Fig-9:** Ready to create the virtual machine summary page.



![Created VM summary in VMware showing the virtual machine settings](ubuntu-to-wazuh/11_created_vm_summary_settings.png)
...
![Virtual Machine Settings, memory configuration screen](ubuntu-to-wazuh/12_virtual_machine_settings_memory_configuration.png)

**Fig-11:** Virtual Machine Settings, memory configuration screen.



![Virtual Machine Settings, CD/DVD ISO selection and Browse button](ubuntu-to-wazuh/13_cd_dvd_iso_selection_browse_button.png)
...
![VMware CD/DVD ISO browser with the downloaded Ubuntu ISO selected](ubuntu-to-wazuh/03_vmware_cd_dvd_iso_browser_ubuntu_iso_selected.png)
 
 **Fig-13:** VMware CD/DVD ISO browser with the downloaded Ubuntu ISO selected.



![Virtual Machine Settings after attaching the Ubuntu ISO to CD/DVD](ubuntu-to-wazuh/14_cd_dvd_ubuntu_iso_attached.png)
...
![Ubuntu installer language selection screen](ubuntu-to-wazuh/15_installer_language_selection.png)

**Fig-15:** Ubuntu installer language selection screen.


![Keyboard layout selection, English (US)](ubuntu-to-wazuh/16_keyboard_layout_english_us.png)
...
![Installer network connection screen](ubuntu-to-wazuh/17_installer_network_connection.png)

**Fig-17:** Installer network connection screen.


![Proxy address screen, left blank for normal installation](ubuntu-to-wazuh/18_proxy_address_blank.png)

**Fig-18:** Proxy address screen, left blank for normal installation.

![Ubuntu archive mirror configuration screen](ubuntu-to-wazuh/19_ubuntu_archive_mirror_configuration.png)
...
![Guided storage layout screen](ubuntu-to-wazuh/20_guided_storage_layout.png)

**Fig-20:** Guided storage layout screen.

![Storage confirmation warning before formatting disk](ubuntu-to-wazuh/21_storage_confirmation_warning.png)
...
![Profile setup screen for name, server name, username, and password](ubuntu-to-wazuh/22_profile_setup_username_password.png)

**Fig-22:** Profile setup screen for name, server name, username, and password.



![Upgrade to Ubuntu Pro screen, skipped](ubuntu-to-wazuh/23_skip_ubuntu_pro.png)
...
![SSH setup screen where OpenSSH Server can be installed](ubuntu-to-wazuh/24_ssh_setup_openssh_server.png)
...
![Featured server snaps screen, continue without selecting optional snaps](ubuntu-to-wazuh/25_featured_server_snaps.png)

**Fig-25:** Featured server snaps screen, continue without selecting optional snaps.



![Ubuntu Server installing packages and system components](ubuntu-to-wazuh/26_ubuntu_server_installing_packages.png)
...
![Installer finished and ready to reboot](ubuntu-to-wazuh/27_installer_finished_ready_to_reboot.png)

**Fig-27:** Installer finished and ready to reboot.



![VMware CD/DVD setting after installation; ISO can be disconnected](ubuntu-to-wazuh/28_vmware_cd_dvd_disconnect_iso_after_install.png)
...
![Ubuntu terminal showing IP information after installation](ubuntu-to-wazuh/29_ubuntu_terminal_ip_information_after_install.png)

**Fig-29:** Ubuntu terminal showing IP information after installation.


![Ubuntu login and first terminal welcome message](ubuntu-to-wazuh/30_ubuntu_login_first_terminal_welcome.png)
...
![Ubuntu terminal showing commands/output for checking IP and SSH/network status](ubuntu-to-wazuh/31_ubuntu_terminal_ip_and_ssh_network_status.png)

**Fig-31:** Ubuntu terminal showing commands/output for checking IP and SSH/network status.



![Ubuntu terminal with network/IP check; useful before PuTTY connection](ubuntu-to-wazuh/33_ubuntu_terminal_network_ip_check_for_putty.png)
...
![PuTTY official download page with Download PuTTY highlighted](ubuntu-to-wazuh/32_putty_official_download_page.png)
...
![PuTTY Configuration: enter Ubuntu IP, port 22, save session, then Open](ubuntu-to-wazuh/34_putty_configuration_ip_port_save_open.png)
...
![PuTTY SSH login screen asking for Ubuntu username/password](ubuntu-to-wazuh/35_putty_ssh_login_username_password.png)
...
![Successful PuTTY SSH login to Ubuntu terminal](ubuntu-to-wazuh/36_successful_putty_ssh_login.png)

**Fig-36:** Successful PuTTY SSH login to Ubuntu terminal.

## 7. Ubuntu install and Wazuh setup.

![ubntu gui search](ubuntu-to-wazuh/37.png)
**Fig-37:** Searched for ubuntu vmware file.
![download1](ubuntu-to-wazuh/38.png)
**Fig-38:** Now this option.
![download2](ubuntu-to-wazuh/39.png)
**Fig-39:** Now click here to download.

![wazuh install code](ubuntu-to-wazuh/40.png)
...
![wazuh connection info](ubuntu-to-wazuh/41.png)

**Fig-41:** Got wazuh login pannel credentials.

![wazuh ip find](ubuntu-to-wazuh/42.png)

**Fig-42:** Check for ubuntu ip address.
![wazuh web1](ubuntu-to-wazuh/43.png)

**Fig-43:** Got wazuh login page.
![wazuh web 2](ubuntu-to-wazuh/44.png)

**Fig-44:** Opening.

![wazuh web 3](ubuntu-to-wazuh/45.png)
...
```
![win1](ubuntu-to-wazuh/46.png)

![win22](ubuntu-to-wazuh/47.png)

![win3](ubuntu-to-wazuh/48.png)


![win4](ubuntu-to-wazuh/50.png)



![win5](ubuntu-to-wazuh/51.png)



![wazuh web 2](ubuntu-to-wazuh/52.png)



![win6](ubuntu-to-wazuh/53.png)



![win7](ubuntu-to-wazuh/54.png)



![win8](ubuntu-to-wazuh/55.png)
